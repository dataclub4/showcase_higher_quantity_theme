function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);enumerableOnly && (symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;})), keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = null != arguments[i] ? arguments[i] : {};i % 2 ? ownKeys(Object(source), !0).forEach(function (key) {_defineProperty(target, key, source[key]);}) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}return target;}function _defineProperty(obj, key, value) {key = _toPropertyKey(key);if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function _toPropertyKey(arg) {var key = _toPrimitive(arg, "string");return typeof key === "symbol" ? key : String(key);}function _toPrimitive(input, hint) {if (typeof input !== "object" || input === null) return input;var prim = input[Symbol.toPrimitive];if (prim !== undefined) {var res = prim.call(input, hint || "default");if (typeof res !== "object") return res;throw new TypeError("@@toPrimitive must return a primitive value.");}return (hint === "string" ? String : Number)(input);}(function ($) {
  ...
  $.fn.selectReplace = function (leaveLabel) {
    ...
    $(this).each(function () {
      ...
      if (!$this.hasClass('cc-init')) {var
        ...
        updateLine = function updateLine() {var $link = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : $this.find('li a[aria-selected="true"], li a.active');
          if ($link.length === 1) {
            $hoverLine.css({
              width: $link.width(),
      ...
      $('.video-container[data-video-type="mp4"]:not(.video--init)', container).addClass('video--init').each(function () {
        ...
        if ($(this).data('video-sources')) {
          ...
          for (var _i2 = 0; _i2 < sources.length; _i2++) {
            var [format, mimeType, url] = sources[_i2].split(' ');
      ...
      then((response) => {
        ...
        if (replacementContent) {
          ...
          if (this.hasAttribute('contains-product-blocks')) {
            var swiperCont = this.querySelector('.swiper-container');
            if (swiperCont) {
      ...
      $.post(shopifyAjaxAddURL, $form.serialize(), function (itemData) {
        ...
        if ($form.hasClass('feedback-add_in_modal') || $form.hasClass('feedback-add_in_modal_no_checkout')) {
          ...
          if (product.options_with_values && product.options_with_values.length) {
            for (var _i3 = 0; _i3 < product.options_with_values.length; _i3++) {
              var option = product.options_with_values[_i3];
  ...
  theme.OptionManager = new function () {
    ...
    _.updateVariantOptionStatusClasses = function (variant, $container) {
      ...
      if (variant && variant.options && variant.options.length > 1) {
        ...
        for (var _i4 = variant.options.length - 1; _i4 >= 0; _i4--) {
          optionValues.pop();

          //Get an object of values for this option all with stock set to false
          var optionAvailability = getAllValuesForOption(_i4);
          ...
          for (var k = 0; k < matchingVariants.length; k++) {
            if (matchingVariants[k].available) {
              var value = matchingVariants[k].options[_i4];
              if (value) {
          ...
          optionStock[productData.options[_i4]] = optionAvailability;
        }
  ...
  theme.HeaderSection = new function () {
    ...
    this.onSectionLoad = function (target) {
      ...
      if (nav.bar.hasInlineLinks() && nav.bar.hasLocalization()) {var
  ...
  theme.FeaturedBlogSection = new function () {
    this.onSectionLoad = function (target) {
      ...
      if ($('.slideshow-blog', target).length) {
        ...
        if ($('.slideshow[data-title-navigation="true"]', target).length) {var
  ...
  theme.ProductTemplateSection = new function () {
    ...
    this.onSectionLoad = function (target) {var isQuickbuy = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      ...
      if (!isFeaturedProduct) {
        ...
        var resizeProductDetails = function resizeProductDetails() {
          if (theme.viewport.isXs()) {
        ...
        };var $stickyAddToCart = $('.product-area__add-to-cart-xs', target);var stickyAddToCartInitialised = !$stickyAddToCart.length;var stickyAddToCartIsUnstuck = false;var productSection = $('.section-product-template')[0];
  ...
  jQuery(function ($) {
    ...
    $(document).on('click', 'body.modal-active .dfd-close-button', function (e) {
      closeThemeModal();
    });
